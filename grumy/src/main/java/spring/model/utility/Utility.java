...
public class Utility {
	...
	public static String rpaging(int totalRecord, int nowPage, int recordPerPage, String col, String word) {
		...
		int _nowPage = (nowGrp - 1) * pagePerBlock; // 10�� ���� �������� �̵�
		if (nowGrp >= 2) {
			str.append("<a href='.?col=" + col + "&word=" + word + "&nowPage=" + _nowPage + "'><img src=\"/grumy/images/page_prev.gif\" alt=\"이전 페이지\"></A>");
		}
		str.append("<ol>");
		...
		for (int i = startPage; i <= endPage; i++) {
			...
			if (nowPage == i) {
				...
				str.append("<li class=\"xans-record-\"><a href='.?col=" + col + "&word=" + word + "&nowPage=" + i + "' class=\"other\">" + i
						+ "</A></li>");
			}
		}
		str.append("</ol>");
	...
	public static String paging2(int totalRecord, int nowPage, int recordPerPage,int itemNo) {
		int pagePerBlock = 10; // ���� ������ ��
		int totalPage = (int) (Math.ceil((double) totalRecord / recordPerPage));
		int totalGrp = (int) (Math.ceil((double) totalPage / pagePerBlock));
		int nowGrp = (int) (Math.ceil((double) nowPage / pagePerBlock));
		...
		int _nowPage = (nowGrp - 1) * pagePerBlock; // 10�� ���� �������� �̵�
		if (nowGrp >= 2) {
			str.append("<a href='read?itemNo=" + itemNo + "&nowPage=" + _nowPage + "#prdQnA"+ "'><img src=\"/grumy/images/page_prev.gif\" alt=\"이전 페이지\"></A>");
		}
		str.append("<ol>");
		...
		for (int i = startPage; i <= endPage; i++) {
			...
			if (nowPage == i) {
				str.append("<li class='active'><a href=#prdQna class=\"this\">" + i + "</a></li>");
			} else {
				str.append("<li class=\"xans-record-\"><a href='read?itemNo=" + itemNo + "&nowPage=" + i + "#prdQnA" + "' class=\"other\">" + i
						+ "</A></li>");
			}
		}
		str.append("</ol>");
		...
		if (nowGrp < totalGrp) {
			str.append(
					"<A href='read?itemNo=" + itemNo +"&nowPage=" + _nowPage + "#prdQnA" + "'><img src=\"/grumy/images/page_next.gif\" alt=\"다음 페이지\"></A>");
		}
	...
	public static String mypaging3(int totalRecord, int nowPager, int recordPerPage, int itemNo) {
		int pagePerBlock = 5; // ���� ������ ��
		int totalPage = (int) (Math.ceil((double) totalRecord / recordPerPage));
		int totalGrp = (int) (Math.ceil((double) totalPage / pagePerBlock));
		int nowGrp = (int) (Math.ceil((double) nowPager / pagePerBlock));
		...
		int _nowPager = (nowGrp - 1) * pagePerBlock; // 10�� ���� �������� �̵�
		if (nowGrp >= 2) {
			str.append("<a href='read?itemNo=" + itemNo + "&nowPager=" + _nowPager + "#prdQnA"+ "'><img src=\"/grumy/images/page_prev.gif\" alt=\"이전 페이지\"></A>");
		}
		str.append("<ol>");
		...
		for (int i = startPage; i <= endPage; i++) {
			...
			if (nowPager == i) {
				...
				str.append("<li class=\"xans-record-\"><a href='read?itemNo=" + itemNo + "&nowPager=" + i + "#prdQnA" + "' class=\"other\">" + i
						+ "</A></li>");
			}
		}
		str.append("</ol>");
		...
		if (nowGrp < totalGrp) {
			str.append(
					"<A href='read?itemNo=" + itemNo +"&nowPager=" + _nowPager + "#prdQnA" + "'><img src=\"/grumy/images/page_next.gif\" alt=\"다음 페이지\"></A>");
			}
