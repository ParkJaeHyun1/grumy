...
<link rel="alternate" href="http://m.slowand.com/product/search.html" />
<meta property="og:url" content="http://slowand.com/product/search.html" />
               ...
               <div class="xans-element- xans-search xans-search-form ">
                  <div class="ec-base-box searchbox">
                     <fieldset>
                        <legend>상품 검색</legend>
                        <div class="item">
                           <strong>상품분류</strong> <select id="category_no"
...
<%-- 												<c:if test="${col ==dto.title || col == dto.itemNo}"> --%>
<!-- 														selected -->
<%-- 														</c:if>  --%>
              				...
              				<div class="item">
								...
								<div class="item">
									<strong>판매가격대</strong> <input id="itemPrice1"
										name="price" fw-filter="isNumber" fw-label="최소판매가격"
										fw-msg="" class="input01" size="15" value=""
										type="text" /> ~ <input id="itemPrice2"
										name="price" fw-filter="isNumber" fw-label="최대판매가격"
										fw-msg="" class="input01" size="15" value=""
										type="text" />
								</div>          
    ...
    -->
               <ul class="prdList grid4">
                  <li id="anchorBoxId_3736" class="xans-record-">
                     <div class="thumbnail">
                        <a
                           href="//slowand.com///product/소프트-하프넥-노르딕니트-5-color/3736/category/122/display/1/"
                           name="anchorBoxName_3736"><img
                           src="//slowand.com/web/product/medium/20191218/8aebbf53627dbc18afb92f78dacbe9fe.webp"
                           id="eListPrdImage3736_" alt="소프트 하프넥 노르딕니트 - 5 color" /> <!--img src="//slowand.com/web/product/small/20191218/ccbaf924c0ff20f0b9b410abf0279523.webp" id="" alt="소프트 하프넥 노르딕니트 - 5 color" class="hover"/--></a>
                        <ul class="button">
                           <li class="option"></li>
                           <li><img
                              src="//slowand.com///web/upload/icon_201807111557294900.png"
                              onClick="CAPP_SHOP_NEW_PRODUCT_OPTIONSELECT.selectOptionCommon(3736,  122, 'basket', '')"
                              alt="장바구니 담기" class="ec-admin-icon cart" /></li>
                           <li class="zoom"><img
                              src="//slowand.com///web/upload/icon_201807111557223600.png"
                              onClick="zoom('3736', '122', '1','', '');"
                              style="cursor: pointer" alt="상품 큰 이미지 보기" /></li>
                           <li class="wish"><img
                              src="/web/upload/icon_201807111557384700.png"
                              class="icon_img ec-product-listwishicon" alt="관심상품 등록 전"
                              productno="3736" categoryno="1" icon_status="off"
                     ...
                     <div class="description">
                        <strong class="name"><a
                           ...
                           class=""><span class="title displaynone"></span> <span
                              style="font-size: 12px; color: #555555;">소프트 하프넥 노르딕니트
                                 - 5 color</span></a></strong>

                        <div class="colorchip ">
                           <div class="xans-element- xans-search xans-search-colorchip">
                              <span style="background-color: #FEFFEF"
                                 class="chips xans-record-"></span> <span
                                 style="background-color: #EDE7DC" class="chips xans-record-"></span><span
                                 style="background-color: #E0B7AA" class="chips xans-record-"></span><span
                                 style="background-color: #ADADAD" class="chips xans-record-"></span><span
                                 style="background-color: #66571C" class="chips xans-record-"></span>
                           </div>
                        </div>
                        <ul class="xans-element- xans-search xans-search-listitem spec">
                           ...
                           <li class=" xans-record-"><strong
                              ...
                              style="font-size: 12px; color: #555555;">늘 사랑받는, 빈티지한
                                 매력의 노르딕니트 *.* <br>패턴자체만으로도 소장가치있는 제품이에요! <br>까슬거림
                                 아예 없이 부드러운 소재로 만나보세요 :)
                           </span></li>
                           <li class=" xans-record-"><strong class="title "><span
                                 style="font-size: 12px; color: #f26d6d;">할인판매가</span> :</strong> <span
                              style="font-size: 12px; color: #f26d6d;">23,700원 <span
  ...
  fbq('track', 'PageView');
   ...
   <!-- CMC script -->
   <!-- CMC script -->
   <div id="fbe_search_script" style="display: none;">
