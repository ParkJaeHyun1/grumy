...
<div class="login">        
	...
	<ul class="find">
	<a href="/member/find_id" class="yg_btn yg_btn4">아이디 찾기</a>
	<a href="/member/find_passwd" class="yg_btn yg_btn4">비밀번호 찾기</a>
    </ul>
	
	<p class="link">
    <a href="/member/join" class="yg_btn yg_btn5" alt="회원가입" 
