...
<link rel="stylesheet" type="text/css"
	href="https://www.slowand.com/ind-script/optimizer.php?filename=rc9BEsIgDAXQA-DWc2SqzngQT4CQQhQShoBOb29bt65sN9kkefmBKBkBnemKVcEy42m4nqH0eyJnYssJ1KPxqBQY9El8AacKWXxPCMlO0hvknhpplHKLVApxOMwzR9gHd8KveZ-Ei9vFleqxLuxINZv5Ctb_3clyeNDKR7R-C_XjddswSJ12iTeKtC3xbCkKxNpsqDa_yQdsa2v41kX-AA&type=css&k=522f4eaf2c70ea400de91ca0f8a30df4f3162c74&t=1566806466" />
							...
							<tbody
								...
								<tr class="xans-record-">
									<td class=""><input id="chk_order_cancel_list0"
										...
										value="3573:000D:F:5268867" type="checkbox"></td>
													...
													578원<br> <input id="product_mileage_card_3573_000D"
														name="product_mileage_card" value="289" type="hidden"><img
															src="//img.echosting.cafe24.com/design/skin/admin/ko_KR/ico_pay_card.gif">
																289원<br> <input
																	id="product_mileage_tcash_3573_000D"
																	name="product_mileage_tcash" value="289" type="hidden"><img
																		src="//img.echosting.cafe24.com/design/skin/admin/ko_KR/ico_pay_bank.gif">
																			289원<br> <input
																				id="product_mileage_cell_3573_000D"
																				name="product_mileage_cell" value="289"
																				type="hidden"><img
																					src="//img.echosting.cafe24.com/design/skin/admin/ko_KR/ico_pay_mobile.gif">
																						289원<br> <input
																							id="product_mileage_icash_3573_000D"
																							name="product_mileage_icash" value="289"
																							type="hidden"><img
								...
								<tr class="xans-record-">
									<td class=""><input id="chk_order_cancel_list1"
										name="chk_order_cancel_list_basic1"
										value="3642:000A:F:5268865" type="checkbox"></td>
									<td class="thumb gClearLine"><a
									...
									<td><span class="txtInfo"><input
											...
											name="product_mileage_cash" value="1292" type="hidden"><img
												src="//img.echosting.cafe24.com/design/skin/admin/ko_KR/ico_pay_money.gif">
													1,292원<br> <input id="product_mileage_card_3642_000A"
														name="product_mileage_card" value="646" type="hidden"><img
															src="//img.echosting.cafe24.com/design/skin/admin/ko_KR/ico_pay_card.gif">
																646원<br> <input
																	id="product_mileage_tcash_3642_000A"
																	name="product_mileage_tcash" value="646" type="hidden"><img
																		src="//img.echosting.cafe24.com/design/skin/admin/ko_KR/ico_pay_bank.gif">
																			646원<br> <input
																				id="product_mileage_cell_3642_000A"
																				name="product_mileage_cell" value="646"
																				type="hidden"><img
																					src="//img.echosting.cafe24.com/design/skin/admin/ko_KR/ico_pay_mobile.gif">
																						646원<br> <input
																							id="product_mileage_icash_3642_000A"
																							name="product_mileage_icash" value="646"
																							type="hidden"><img
																								src="//img.echosting.cafe24.com/design/skin/admin/ko_KR/ico_pay_account.gif">
																									646원</span></td>
									<td><div class="txtInfo">
										...
										readonly="1" value="" type="text"> <a href="#none"
											id="btn_search_ozipcode" class="yg_btn_24 yg_btn5" alt="우편번호">우편번호</a><br>
												...
												placeholder="" size="40" readonly="1" value="" type="text">
													<span class="txtInfo">기본주소</span><br> <input
														id="oaddr2" name="oaddr2" fw-filter="isFill"
														fw-label="주문자 주소2" fw-msg="" class="inputTypeText"
														placeholder="" size="40" value="" type="text"> <span
															class="txtInfo">나머지주소</span><span
											...
											id="btn_search_rzipcode" class="yg_btn_24 yg_btn5" alt="우편번호">우편번호</a><br>
												...
												placeholder="" size="40" readonly="1" value="" type="text">
													<span class="grid">기본주소</span><br> <input id="raddr2"
														name="raddr2" fw-filter="isFill" fw-label="수취자 주소2"
					...
					<div class="payment">
						<div class="method">
							<span class="ec-base-label"><input id="addr_paymethod0"
								...
								name="addr_paymethod" fw-filter="isFill" fw-label="결제방식"
								fw-msg="" value="card" type="radio" checked="checked"><label
								...
								fw-msg="" value="cell" type="radio"><label
									for="addr_paymethod3">휴대폰 결제</label></span> <span
								class="ec-base-label"><input id="addr_paymethod4"
								name="addr_paymethod" fw-filter="isFill" fw-label="결제방식"
								fw-msg="" value="icash" type="radio"><label
						...
						<div class="ec-base-table typeWrite">
							...
							<div id="kpay_info" class="payHelp" style="display: none;">
								...
								<p class="ec-base-help">
									안드로이드의 경우 구글 플레이, 아이폰의 경우 앱 스토어에서 케이페이 앱을 설치 한 후,<br> 최초
										1회 카드정보를 등록하셔야 사용 가능합니다. 
								</p>
							</div>
							...
							<div id="paynow_info" class="payHelp" style="display: none;">
								<p class="ec-base-help">휴대폰에 설치된 페이나우 앱에서 비밀번호 입력만으로 빠르고
									안전하게 결제가 가능한 서비스 입니다.</p>
								<p class="ec-base-help">
									안드로이드의 경우 구글 플레이, 아이폰의 경우 앱 스토어에서 페이나우 앱을 설치 한 후,<br> 최초
										1회 카드 및 계좌 정보를 등록하셔야 사용 가능합니다 
								</p>
							</div>
							...
							<div id="kakaopay_info" class="payHelp" style="display: none;">
								<p class="ec-base-help">휴대폰에 설치된 카카오톡 앱에서 비밀번호 입력만으로 빠르고
									안전하게 결제가 가능한 서비스 입니다.</p>
								<p class="ec-base-help">
									안드로이드의 경우 구글 플레이, 아이폰의 경우 앱 스토어에서 카카오톡 앱을 설치 한 후,<br> 최초
										1회 카드 및 계좌 정보를 등록하셔야 사용 가능합니다. 
								</p>
														...
														<tr>
															...
															<td><input id="cashreceipt_user_type20"
																...
																value="0" type="radio"><label
																	for="cashreceipt_user_type20">개인</label> <input
																	id="cashreceipt_user_type21"
																	name="cashreceipt_user_type2" fw-filter=""
																	fw-label="현금영수증 신청자 종류-신청여부라디오버튼과 함께" fw-msg=""
																	value="1" type="radio"><label
																		for="cashreceipt_user_type21">사업자</label></td>
														</tr>
...
④ 이용자가 재화등을 제공받을때 발송비를 부담한 경우에 “몰”은 청약 철회시 그 비용을 누가 부담하는지를 이용자가 알기 쉽도록 명확하게 표시합니다.</textarea>
											...
											<div id="eguarantee_personal">
												<p>
													생년월일 : <input id="eguarantee_year" name="eguarantee_year"
														...
														maxlength="4" value="" type="text" disabled=""> 년
														<input id="eguarantee_month" name="eguarantee_month"
														fw-filter="" fw-label="전자보증보험 생년월일2" fw-msg=""
														class="inputTypeText" placeholder="" size="2"
														maxlength="2" value="" type="text" disabled=""> 월
															<input id="eguarantee_day" name="eguarantee_day"
						...
						<div class="">
							...
							<ol>
								...
								<li class="item2">결제가능브라우저 : 크롬,파이어폭스,사파리,오페라 브라우저에서 결제 가능<br>(단,
										window os 사용자에 한하며 리눅스/mac os 사용자는 사용불가) </li>
				...
				<div id="ec-shop_orderConfirmLayer" class="orderConfirmLayer">
					...
					<div class="orderConfirmLayer ec-base-layer">
						...
						<div class="content">
							<p class="desc">아직 주문이 완료되지 않았으니, 작성하신 내용을 확인하신 후에 주문 완료해
								주세요.</p>
							<div class="confirm">
								<!-- 주문 상품 정보 -->
								<div class="title">
										...
										<tfoot class="right">
											<tr>
												<td colspan="8"><span class="gLeft">[기본배송]</span>
													상품구매금액 <strong>96,900<span class="displaynone">
															(0)</span></strong> + 배송비 <span id="ec-shop-confirm_domestic_ship_fee">0
																...
																578원<br> <input id="product_mileage_card_3573_000D"
																	name="product_mileage_card" value="0" type="hidden"><img
																		src="//img.echosting.cafe24.com/design/skin/admin/ko_KR/ico_pay_card.gif">
																			289원<br> <input
																				id="product_mileage_tcash_3573_000D"
																				name="product_mileage_tcash" value="289"
																				type="hidden"><img
																					src="//img.echosting.cafe24.com/design/skin/admin/ko_KR/ico_pay_bank.gif">
																						289원<br> <input
																							id="product_mileage_cell_3573_000D"
											...
											<tr class="xans-record-">
												...
												<td><span class="txtInfo"><input
														...
														name="product_mileage_cash" value="1292" type="hidden"><img
															src="//img.echosting.cafe24.com/design/skin/admin/ko_KR/ico_pay_money.gif">
																1,292원<br> <input
																	id="product_mileage_card_3642_000A"
																	name="product_mileage_card" value="0" type="hidden"><img
																		src="//img.echosting.cafe24.com/design/skin/admin/ko_KR/ico_pay_card.gif">
																			646원<br> <input
																				id="product_mileage_tcash_3642_000A"
																				name="product_mileage_tcash" value="646"
																				type="hidden"><img
																					src="//img.echosting.cafe24.com/design/skin/admin/ko_KR/ico_pay_bank.gif">
																						646원<br> <input
																							id="product_mileage_cell_3642_000A"
											...
											<tr>
												<td colspan="8"><span class="gLeft">[업체기본배송]</span>
													상품구매금액 <strong><span class="displaynone">
															()</span></strong> + 배송비 <span class="displaynone"> - 상품할인금액 </span> = 합계
													: <strong class="txtEm gIndent10"><span
														class="txt23"></span></strong> <span class="displaynone"></span></td>
											</tr>
										</tfoot>
									</table>
									<!-- 개별배송 -->
											...
											<thead>
												<tr>
													...
													<th scope="col" id="ec-shop-confirm_total_sale_area1"
														...
														class="">할인</span><span id="plus_mark" class=""> +
													</span><span id="total_addpay_text" class="">부가결제</span><span>
															금액</span></th>
												...
												<tr>
													...
													<td>
														<div class="box txtEm txt16">
															<strong>= <strong
																id="ec-shop-confirm_total_order_price_view"
																class="txt23"></strong>원
