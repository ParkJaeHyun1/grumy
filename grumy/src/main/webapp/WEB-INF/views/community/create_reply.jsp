			...
			<form id="boardWriteForm" name="frm"
				...
				<div class="ec-base-table typeWrite ">
					...
					<tr class=""> 
							...
							<td><input id="secure2" name="secure" 
						fw-filter="isFill" fw-label="비밀글설정" fw-msg="" value="F" onclick="return(false);" 
									type="radio" checked="checked"><label for="secure1">공개글</label>
